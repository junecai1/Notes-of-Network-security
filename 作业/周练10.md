...
##### setp1: `vol.py -f worldskills3.vmem imageinfo` 获取信息
...
##### setp2: `vol.py -f worldskills3.vmem –profile=Win7SP1x64 printkey -K “SAM\Domains\Account\Users\Names”` 获取用户
...
##### setp3:`volatility_2.6_win64_standalone.exe -f worldskills3.vmem --profile=Win7SP1x64 hashdump` 查看密码哈希值
